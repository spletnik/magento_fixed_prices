...
class Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Super_Config_Simple extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Attributes {
    ...
    protected function _prepareForm() {
        ...
        /*
        $fieldset->addField('fixedPricing', 'checkbox', array(
            'id' => 'fixedPricing',
            'label' => Mage::helper('catalog')->__('Use fixed pricing'),
            'required' => false
        ));
        */
        ...
        foreach ($this->_getProduct()->getTypeInstance(true)->getUsedProductAttributes($this->_getProduct()) as $attribute) {
            ...
            $fieldset->addField('simple_product_' . $attributeCode, 'select', array(
                ...
                'required' => true,
                'class'    => 'validate-configurable attr-order',
        ...
        $fieldset->addField('fixed_price', 'text', array(
            'label'    => Mage::helper('catalog')->__('Product final price'),
            'name'     => 'fixed_price',
            'required' => true,
            'class'    => 'validate-number toggleDisplay',
        ));

        $fieldset->addField('fixed_special_price', 'text', array(
            'label'    => Mage::helper('catalog')->__('Product special price'),
            'name'     => 'fixed_special_price',
            'required' => false,
            'class'    => 'validate-number toggleDisplay',
        ));
